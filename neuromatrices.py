...
dataset_loc = 'data/dataset-old.pkl'
neurosynth_image_loc = 'data/results-old/'
...
with h5py.File('neurodata.hdf5') as f:
	...
	add_h5py_voxel_feature_matrix(f, dataset, neurosynth_image_loc, 'nsynth_data')
	...
	for (i,folder) in enumerate(subject_folders):
		...
		add_h5py_voxel_activity_matrix(f, dataset, image_folder_path, folder)
		print(folder + ' added.')
